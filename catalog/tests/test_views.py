...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_logged_in_with_permission_another_users_borrowed_book(self):
        ...
        # Check that it lets us login. We're librarian, so we can view any users book
        self.assertEqual(response.status_code, 200)
...
class AuthorCreateViewTest(TestCase):
    def setUp(self):
        ...
        test_author = Author.objects.create(
            first_name="John", last_name="Smith", date_of_birth="1988-12-16"
        )
    ...
    # Check initial date
    def test_initial_date_of_death_create_author(self):
        login = self.client.login(username="test_user", password="some_password")
        response = self.client.get(reverse("author-create"))
        self.assertEqual(response.status_code, 200)
        self.assertEqual(
    ...
    def test_redirects_created_author_on_success(self):
        login = self.client.login(username="test_user", password="some_password")
        new_author = {
            "first_name": "Joao",
            "last_name": "Limao",
